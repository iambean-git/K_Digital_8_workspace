...
public class QueryStatement {
	...
	public QueryStatement(Scanner sc) {
		super();
		this.sc = sc;
	}
	...
	public static void question1(Statement st) {
	...
	public static void question2(Statement st) {
		ResultSet rs = null;
	...
	public static void question3(Statement st) {
		ResultSet rs = null;
	...
	public static void question4(Statement st) {
		ResultSet rs = null;
		...
		try {
			...
			rs = st.executeQuery("select name, surfacearea from country where surfacearea < " + val + "order by surfacearea asc");
	...
	public static void question5(Statement st) {
		ResultSet rs = null;
		...
		try {
			...
			rs = st.executeQuery("select name from city where Countrycode = 'kor' and District='" + val + "' ;");
	...
	public static void question6(Statement st) {
		ResultSet rs = null;
		...
		try {
			...
			rs = st.executeQuery("select name from country, countrylanguage where country.Code=countrylanguage.CountryCode and IsOfficial='T' and Language='"
							+ val + "';");
	...
	public static void question7(Statement st) {
		ResultSet rs = null;
		...
		try {
			...
			rs = st.executeQuery(
					"select countrycode , Percentage from countrylanguage where Percentage > " + val + " ;");
